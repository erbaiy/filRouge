                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <h2 class="mb-5">Total number of availabile rooms </h2>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Reserve</p>
                                        </div>
                                        <h4 class="font-weight-bolder">{{ $completedReservationCount }}</h4>
                                        <div class="progress w-75">
